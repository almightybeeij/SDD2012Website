		...
		<div id="mainContentPaneAdminUpdate">
			...
			$previousLotID = NULL;
				...
				if(isset($_POST['update']))
				{
					...
					$sqlSetup = "select * from parkinglot;";
					...
					echo "<input type='hidden' name='lotId' value='$_POST[lotId]'/>";
				...
				if(isset($_POST['edit']))
				{
					...
					if($_POST['spaceId'] == 'new')
					{
						...
						echo "<td><input type='text' class='smallFont' style='width:100%' name='ParkingLot_lotId' value='new'></td>";
					...
					if ($row[spaceId] == $_POST['spaceId'])
					{
						...
						echo "<tr>";
						echo "<input type='hidden' name='lotId' value='$_POST[lotId]'/>";
						echo "<td><input type='text' class='smallFont' style='width:100%' name='spaceId' value='$row[spaceId]'></td>";
						echo "<td><input type='text' class='smallFont' style='width:100%' name='ParkingLot_lotId' value='$row[ParkingLot_lotId]'></td>";
					...
					else
					{
						...
						echo "<td><input type='hidden' style='width:100%' name='ParkingLot_lotId' value='$row[ParkingLot_lotId]'>$row[ParkingLot_lotId]</td>";
