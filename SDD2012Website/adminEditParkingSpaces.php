		...
		<div id="mainContentPaneAdminUpdate">
			...
			$previousLotID = NULL;
				...
				if(isset($_POST['delete']))
				{
					...
					{
						$sqlDelete = "delete from parkinglot where spaceId=$_POST[spaceId]";
				...
				if(isset($_POST['update']))
				{
					...
					if($isKosher == NULL)
					{
						...
						if ($num_results <= 0)
						{
							$sqlInsert = "insert into parkingspace values ($_POST[lotId],$_POST[spaceId], '$_POST[clientEmail]',$_POST[available] ,$_POST[handicap] ,'$_POST[corner1]','$_POST[corner1]','$_POST[corner1]','$_POST[corner1]');";
						...
						{
							$sqlUpdate = "update parkingspace set Client_email = '$_POST[clientEmail]', available=$_POST[available], handicap=$_POST[handicap], corner1='$_POST[corner1]', corner2='$_POST[corner2]', corner3='$_POST[corner3]', corner4='$_POST[corner4]', where ParkingLot_lotId=$lotId and spaceId=$_POST[spaceId];";
						...
						echo "AHDHDHSAHDH $isKosher<br>";
					
					$sqlSetup = "select * from parkinglot order by lotId desc;";
					...
					$sqlSelect = "select * from parkingspace where ParkingLot_lotId='$_POST[lotId]';";
					...
					if(isset($isKosher) && $num_results != NULL)
					{
				...
				if(isset($_POST['edit']))
				{
					...
					if($_POST['spaceId'] == 'new')
					{
						...
						echo "<td><input type='text' class='smallFont' style='width:100%' name='Client_email' value='new'></td>";
					...
					else
					{
						...
						echo "<td><input type='hidden' style='width:100%' name='Client_email' value='new'>New</td>";
					...
					if ($row[spaceId] == $_POST['spaceId'])
					{
						...
						echo "<td><input type='text' class='smallFont' style='width:100%' name='Client_email' value='$row[Client_email]'></td>";
					...
					else
					{
						...
						echo "<td><input type='hidden' style='width:100%' name='Client_email' value='$row[Client_email]'>$row[Client_email]</td>";
